...
- **Nested Struct Support**: Recursively converts nested struct fields into nested maps.
...
- **Recursion Depth**: Control nesting depth with `-depth=N`.
...
├── template/                # Code templates (package)
