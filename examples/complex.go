...
type ComplexStruct struct {
	...
	// Slice of structs from another package
	UsersIn models.Users `structtomap:"users_in"`
	...
	// Field of to a struct
	ActiveUser models.User `structtomap:"active_user"`
	...
	Account    Account         `structtomap:"account"`
	Accounts   Accounts        `structtomap:"accounts"`
}
